...
function OurReachSection() {
    return (
        <section className='w-full main-container overflow-hidden flex flex-col items-center justify-center gap-6 my-24 '>
            <div>
            <h1 className="text-4xl text-pink-500 font-extrabold text-center mb-4">Our Reach</h1>
            </div>
            <div className='w-flex flex lg:flex-row flex-col items-center justify-center gap-4'>
           ...
           <h1 className='text-4xl text-gray-700 '>45,00,000+ <br/>Corporate Professionals</h1>
           <p className='text-gray-600 text-lg'> Working in leading MNCs like IBM, Facebook, TCS, Cognizant Google, Amazon, Linkedin, Delloite, Wells Fargo, Target, Accenture, and more</p>
